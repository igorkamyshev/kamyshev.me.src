...
_Образовательная платформа [Stomweb](https://stomweb.ru) для врачей-стоматологов._

_Написал сервис для нарезки загруженного видео на фрагменты и последующего стриминга. Сделал [библиотеку для работы с модалками](https://github.com/breadhead/use-modal/) (корректно работает с URL, нет проблоем с SSR). Перевел легаси-код админки на PHP7, завернул её в Docker, добавил новые формы и исправил баги в старых._
