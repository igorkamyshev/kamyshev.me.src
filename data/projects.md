...
_Образовательная платформа [Stomweb](https://stomweb.ru) предоставляет врачам-стоматологам доступ до фундаментальноых знаний, на которых построены американская и европейская школы стоматологии._

_Написал сервис для нарезки загруженного видео на фрагменты и последующего стриминга. Сделал [библиотеку для работы с модалками](https://github.com/breadhead/use-modal/) (корректно работает с URL, нет проблоем с SSR) и внедрил ее в проект. Перевел легаси-код админки на PHP7, завернул её в Docker._
